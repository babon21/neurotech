    ...
    <GridContainer>
      ...
      <GridItem xs={12} sm={12} md={12}>
        <CustomTable
          ...
          tables={[
            {
              tabName: "Кандидатские диссертации",
              tabContent: (
                <ActionTable
                  ...
                  tableData={[
                    ["Dakota Rice", "Разработка системы распознавания семантики и прагматики предложений на естественном языке на основе нейронных сетей", "Oud-Turnhout"],
            ...
            {
              tabName: "Магистерские диссертации",
              tabContent: (
                <ActionTable
                  tableHeaderColor="primary"
                  tableHead={["Name", "Student work", "Year"]}
            ...
            {
              tabName: "Выпускные бакалаврские работы",
              tabContent: (
                <ActionTable
                  tableHeaderColor="primary"
                  tableHead={["Name", "Student work", "Year"]}
